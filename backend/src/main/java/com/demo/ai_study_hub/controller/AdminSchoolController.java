...
public class AdminSchoolController {
    ...
    @PostMapping("/schools")
    public ResponseEntity<ApiResponse<SchoolDto>> createSchool(@RequestBody SchoolDto dto) {
