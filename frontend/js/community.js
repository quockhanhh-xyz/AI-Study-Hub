  ...
  function createCommunityCard(doc) {
    ...
    if (doc.subjectCode || doc.subjectName) {
      ...
      const subjectText = doc.subjectCode
        ...
        : doc.subjectName;
      subjectItem.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" height="12" width="12" stroke="currentColor" stroke-width="2.5" style="vertical-align: -1px; margin-right: 4px;"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82zM7 7h.01"/></svg> Môn: ${subjectText}`;
