...
| `user_id` | INT | FOREIGN KEY REFERENCES `users(user_id)`, NOT NULL | User associated with the reservation |
| `request_type` | VARCHAR(50) | NOT NULL | Type of AI action (e.g., `ASK`, `CHAT`, `SUMMARY`) |
| `status` | VARCHAR(30) | NOT NULL | Status of reservation: `RESERVED`, `CONFIRMED`, `RELEASED` |
